...
var ZoomMeetingConfiguration = (function () {
   ...
   * @param {Function} onJoinMeetingNeedUserInfo When joining the meeting, this callback is triggered if the user needs to input a username and email.
   * @param {Function} onUserConfirmToStartArchive Callback event when joining a meeting if the admin allows the the user to choose to archive the meeting.
  ...
  function init(opts) {
    ...
    let _onWebinarNeedInputScreenName = clientOpts.onWebinarNeedInputScreenName || null;
    let _onJoinMeetingNeedUserInfo = clientOpts.onJoinMeetingNeedUserInfo || null;
    let _onUserConfirmToStartArchive = clientOpts.onUserConfirmToStartArchive || null;
    ...
    */
    ...
    /**
      ...
      @event onJoinMeetingNeedUserInfo
    */
    function onJoinMeetingNeedUserInfo() {
      if (_onJoinMeetingNeedUserInfo) {
        _onJoinMeetingNeedUserInfo()
      }
    }

    /**
      Callback event when joining a meeting if the admin allows the the user to choose to archive the meeting.
      @event onUserConfirmToStartArchive
    */
    function onUserConfirmToStartArchive() {
      if (_onUserConfirmToStartArchive) {
        _onUserConfirmToStartArchive()
      }
    }
