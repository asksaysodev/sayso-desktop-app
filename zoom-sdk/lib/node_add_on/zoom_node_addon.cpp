...
NODE_MODULE_INIT(/* exports, module, context */) {
	...
	ZoomNodeSettingWallpaperCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeSettingVirtualBGCtrlWrap::Init(exports->GetIsolate());
	...
	ZoomNodeMeetingAICompanionCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingIndicatorCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingWebinarCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeRequestRawLiveStreamPrivilegeHandlerWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingQACtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingReactionCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeCloseCaptionCtrlWrap::Init(exports->GetIsolate());
	ZoomNodePollingCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingWhiteboardCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingDocsCtrlWrap::Init(exports->GetIsolate());
...
v8::Persistent<v8::Function> ZoomNodeSettingWallpaperCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeSettingVirtualBGCtrlWrap::constructor;
...
v8::Persistent<v8::Function> ZoomNodeMeetingAICompanionCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingIndicatorCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingWebinarCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingQACtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingReactionCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeCloseCaptionCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodePollingCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingWhiteboardCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingDocsCtrlWrap::constructor;
///////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
...
void ZoomNodeAuthWrap::SetLogoutCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		ZoomNodeSinkHelper::GetInst().onLogout.Reset(isolate, cbfunc);
...
void ZoomNodeAuthWrap::SetOnAuthReturnCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onAuthenticationReturn.Reset(isolate, cbfunc);
...
void ZoomNodeAuthWrap::SetOnZoomIdentityExpiredCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onZoomIdentityExpired.Reset(isolate, cbfunc);
...
void ZoomNodeAuthWrap::SetOnZoomAuthIdentityExpiredCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onZoomAuthIdentityExpired.Reset(isolate, cbfunc);
...
void ZoomNodeAuthWrap::SetLoginReturnWithReasonCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onLoginReturnWithReason.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::Join_WithoutLogin(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (proto_params.has_onbehalftoken())
		{
			joinWithoutLoginParam.onBehalfToken = s2zs(proto_params.onbehalftoken());
		}
...
void ZoomNodeMeetingWrap::CanSetMeetingTopic(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	bool zn_bCan = _g_native_wrap.GetMeetingServiceWrap().CanSetMeetingTopic();
	v8::Local<v8::Boolean> bret = v8::Boolean::New(isolate, zn_bCan);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingWrap::SetMeetingTopic(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetMeetingTopicParam proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetMeetingTopicParam >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_stopic())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		ZoomSTRING zn_sTopic;
		zn_sTopic = s2zs(proto_params.stopic());
		err = _g_native_wrap.GetMeetingServiceWrap().SetMeetingTopic(zn_sTopic);
	} while (false);
...
void ZoomNodeMeetingWrap::SetMeetingStatusCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onMeetingStatusChanged.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::SetMeetingStatisticsWarningNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onMeetingStatisticsWarningNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::SetMeetingParameterNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onMeetingParameterNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::SetOnMeetingTopicChangedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingTopicChanged.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onMeetingTopicChanged.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::SetOnMeetingFullToWatchLiveStreamCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingFullToWatchLiveStream.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onMeetingFullToWatchLiveStream.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingWrap::GetMeetingAICompanionCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingAICompanionCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingIndicatorCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingIndicatorCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingWebinarCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingWebinarCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingQACtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingQACtrlWrap::NewInstance(args);
}

void ZoomNodeMeetingWrap::GetMeetingReactionCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingReactionCtrlWrap::NewInstance(args);
}

void ZoomNodeMeetingWrap::GetMeetingCloseCaptionCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeCloseCaptionCtrlWrap::NewInstance(args);
}

void ZoomNodeMeetingWrap::GetMeetingPollingCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodePollingCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingWhiteboardCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingWhiteboardCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingDocsCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingDocsCtrlWrap::NewInstance(args);
}
...
void ZoomNodeMeetingInfoWrap::GetInviteEmailTemplate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZoomSTRING invite_email_teamplate = _g_native_wrap.GetMeetingServiceWrap().GetMeetingInfo().GetInviteEmailTemplate();
...
void ZoomNodeMeetingUICtrlWrap::SwitchToActiveSpeaker(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SwitchToActiveSpeaker();
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
...
void ZoomNodeMeetingUICtrlWrap::ChangeFloatToActiveSpkVideoSize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::ChangeFloatToActiveSpkVideoSizeParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::ChangeFloatToActiveSpkVideoSizeParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		...
		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().ChangeFloatToActiveSpkVideoSize(_zn_sdk_float_video_type);
	} while (false);
...
void ZoomNodeMeetingUICtrlWrap::SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(_mode);
	} while (false);
	
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingUICtrlWrap::IsMinimizeModeOfFirstScreenMeetingUIWnd(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	auto context = isolate->GetCurrentContext();
	ZNSDKMinimizeUIMode mode = ZN_MinimizeUIMode_NONE;
	bool zn_bIsMinimizMode = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().IsMinimizeModeOfFirstScreenMeetingUIWnd(mode);
...
void ZoomNodeMeetingUICtrlWrap::SetInviteButtonClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onInviteBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonStartShareBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onStartShareBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonEndMeetingBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onEndMeetingBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonParticipantListBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onParticipantListBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonCustomLiveStreamMenuClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onCustomLiveStreamMenuClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonZoomInviteDialogFailedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onZoomInviteDialogFailed.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonCCBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onCCBTNClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonAudioBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onAudioBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingUICtrlWrap::SetonAudioMenuBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onAudioMenuBtnClicked.Reset(isolate, cbfunc);
...
void ZoomNodeSettingWrap::GetSettingWallpaperCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeSettingWallpaperCtrlWrap::NewInstance(args);
}
void ZoomNodeSettingWrap::GetSettingVirtualBGCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeSettingVirtualBGCtrlWrap::NewInstance(args);
}
