...
UVIPCMessage* MakeUVIPCMsg(AudioRawData* data_, unsigned int user_id_, unsigned int type)
{
	if (NULL == data_)
		return NULL;
...
UVIPCMessage* MakeUVIPCMsg(ZoomNodeAudioRawdata* data_, unsigned int user_id_, unsigned int type)
{
	if (NULL == data_)
		return NULL;
