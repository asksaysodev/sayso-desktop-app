...
void ZMeetingServiceWrap::onMeetingTopicChanged(ZoomSTRING sTopic)
{
	if (m_pSink)
		m_pSink->onMeetingTopicChanged(sTopic);
}
void ZMeetingServiceWrap::onMeetingFullToWatchLiveStream(ZoomSTRING sLiveStreamUrl)
{
	if (m_pSink)
		m_pSink->onMeetingFullToWatchLiveStream(sLiveStreamUrl);
}
...
{
	return ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().CanSetMeetingTopic();
}
ZNSDKError ZMeetingServiceWrap::SetMeetingTopic(ZoomSTRING sTopic)
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().SetMeetingTopic(sTopic.c_str()));
}
...
ZoomSTRING ZMeetingInfoWrap::GetInviteEmailTemplate()
{
	...
	if (pMeetingInfo)
	{
		inviteEmailTeamplate = pMeetingInfo->GetInviteEmailTemplate();
	}
...
ZNSDKError ZMeetingUICtrlWrap::SwitchToActiveSpeaker()
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetUIController().SwitchToActiveSpeaker());
}
...
ZNSDKError ZMeetingUICtrlWrap::ChangeFloatToActiveSpkVideoSize(ZNSDKFloatVideoType type)
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetUIController().ChangeFloatToActiveSpkVideoSize(Map2SDKDefine(type)));
}
...
ZNSDKError ZMeetingUICtrlWrap::SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(ZNSDKMinimizeUIMode mode)
{
	ZOOM_SDK_NAMESPACE::SDKMinimizeUIMode sdk_mode = Map2SDKDefine(mode);
	ZOOM_SDK_NAMESPACE::SDKError sdk_err = ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetUIController().SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(sdk_mode);
	ZNSDKError err = Map2WrapDefine(sdk_err);
	return err;
}
bool ZMeetingUICtrlWrap::IsMinimizeModeOfFirstScreenMeetingUIWnd(ZNSDKMinimizeUIMode &mode)
{
	ZOOM_SDK_NAMESPACE::SDKMinimizeUIMode sdk_mode = Map2SDKDefine(mode);
	bool b_isMinimizMode = ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetUIController().IsMinimizeModeOfFirstScreenMeetingUIWnd(sdk_mode);
	switch (sdk_mode)
	{
