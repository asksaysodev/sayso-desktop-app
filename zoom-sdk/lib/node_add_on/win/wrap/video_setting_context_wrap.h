...
public:
#define T_GetTestVideoDeviceHelper _GetTestVideoDeviceHelper
#else
#define T_GetTestVideoDeviceHelper GetTestVideoDeviceHelper
#endif
DEFINE_FUNC_AND_MEMBER(T_GetTestVideoDeviceHelper, ITestVideoDeviceHelperWrap)
