...
IMPL_FUNC_1(ICustomizedShareRender, SetShareSourceID, SDKError, unsigned int, nShareSourceID, SDKERR_UNINITIALIZE)
IMPL_FUNC_0(ICustomizedShareRender, GetShareSourceID, unsigned int, SDKERR_UNINITIALIZE)
