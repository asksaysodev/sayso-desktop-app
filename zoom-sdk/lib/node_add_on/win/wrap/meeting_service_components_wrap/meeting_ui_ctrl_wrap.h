...
DEFINE_FUNC_0(SwitchToActiveSpeaker, SDKError)
...
DEFINE_FUNC_1(ChangeFloatToActiveSpkVideoSize, SDKError, SDKFloatVideoType, type)
...
DEFINE_FUNC_1(IsMinimizeModeOfFirstScreenMeetingUIWnd, bool, SDKMinimizeUIMode&, mode)
//virtual SDKError SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(SDKMinimizeUIMode mode) = 0;
DEFINE_FUNC_1(SwitchMinimizeUIMode4FirstScreenMeetingUIWnd, SDKError, SDKMinimizeUIMode, mode)
