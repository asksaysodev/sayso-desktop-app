...
IMeetingLiveStreamItemImpl::IMeetingLiveStreamItemImpl(const zchar_t* liveStreamURL, const zchar_t* liveStreamURLDescription, const zchar_t* liveStreamViewerURL)
{
	_liveStreamURL = liveStreamURL;
	_liveStreamURLDescription = liveStreamURLDescription;
	_liveStreamViewerURL = liveStreamViewerURL;
}
...
void IMeetingLiveStreamItemImpl::SetLiveStreamViewerURL(const zchar_t* liveStreamViewerURL)
{
	_liveStreamViewerURL = liveStreamViewerURL;
}
const zchar_t* IMeetingLiveStreamItemImpl::GetLiveStreamViewerURL()
{
	return _liveStreamViewerURL.c_str();
}
...
IMPL_FUNC_0(IMeetingLiveStreamController, GetSupportLiveStreamItems, IList<IMeetingLiveStreamItem*>*, NULL)
// virtual IMeetingLiveStreamItem* GetCurrentLiveStreamItem() = 0;
IMPL_FUNC_0(IMeetingLiveStreamController, GetCurrentLiveStreamItem, IMeetingLiveStreamItem*, NULL)
...
IMPL_FUNC_0(IMeetingLiveStreamController, IsLiveStreamReminderEnabled, bool, false)
//virtual bool CanEnableLiveStreamReminder() = 0;
IMPL_FUNC_0(IMeetingLiveStreamController, CanEnableLiveStreamReminder, bool, false)
//virtual SDKError EnableLiveStreamReminder(bool enable) = 0;
IMPL_FUNC_1(IMeetingLiveStreamController, EnableLiveStreamReminder, SDKError, bool, enable, SDKERR_UNINITIALIZE)
