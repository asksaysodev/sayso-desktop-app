...
IMPL_FUNC_0(IMeetingParticipantsController, GetMySelfUser, IUserInfo*, NULL)
...
//virtual IUserInfo* GetBotAuthorizedUserInfoByUserID(unsigned int robotUserId) = 0;
IMPL_FUNC_1(IMeetingParticipantsController, GetBotAuthorizedUserInfoByUserID, IUserInfo*, unsigned int, userid, NULL)
//virtual IList<unsigned int >* GetAuthorizedBotListByUserID(unsigned int userid) = 0;
IMPL_FUNC_1(IMeetingParticipantsController, GetAuthorizedBotListByUserID, IList<unsigned int >*, unsigned int, userid, NULL)
