...
{
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().Init_Wrap(&g_auth_service_wrap);
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().SetEvent(&SDKEventWrapMgr::GetInst().m_directShareHelperWrapEvent);
}
void ZDirectShareHelperWrap::Uninit()
{
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().SetEvent(NULL);
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().Uninit_Wrap();
}
...
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().CanStartDirectShare());
}
bool ZDirectShareHelperWrap::IsDirectShareInProgress()
{
	return ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().IsDirectShareInProgress();
}
ZNSDKError ZDirectShareHelperWrap::StartDirectShare()
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().StartDirectShare());
}
ZNSDKError ZDirectShareHelperWrap::StopDirectShare()
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().T_GetDirectShareServiceHelper().StopDirectShare());
}
