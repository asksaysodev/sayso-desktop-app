...
## Documentation
Please visit [Zoom Electron SDK](https://developers.zoom.us/docs/meeting-sdk/electron/) to learn how to use the SDK and run the sample application.
...
1. Follow the steps below to install protobuf 22.3
    ...
    * Download abseil-cpp 20230802.1 from https://github.com/abseil/abseil-cpp/tree/20230802.1, put absl folder to protobuf_src
    * Copy the protobuf_src folder into the lib/node_add_on
2. Run the command `npm run electron:serve`
...
For the changelog, see [Meeting SDK - Electron](https://devsupport.zoom.us/hc/en-us/sections/11766698871693-Electron).
