...
@property (nonatomic, readonly, strong) CheckboxViewImpl * _Nullable firstCheckboxView;
...
/// <h2>Reference</h2>
/// <a href="https://www.figma.com/file/fLGhhzkzA1tlvZOg00to2L/Prism-Component-Library-(MVP)?type=design&node-id=683-3"><em>Figma</em>: Checkbox Design Specification</a>
SWIFT_CLASS("_TtC5Prism16CheckboxViewImpl")
@interface CheckboxViewImpl : PZMCheckboxView
/// The checkbox’s selection state.
@property (nonatomic) enum PZMCheckboxViewState state;
@property (nonatomic, copy) void (^ _Nullable onStateChange)(PZMCheckboxView * _Nonnull, BOOL);
@property (nonatomic) BOOL requiresTracking;
...
/// returns:
/// A new <code>CheckboxView</code> instance.
- (nonnull instancetype)initWithItem:(PZMCheckboxItem * _Nonnull)item OBJC_DESIGNATED_INITIALIZER;
- (void)mouseUp:(NSEvent * _Nonnull)event;
@property (nonatomic) NSSize intrinsicContentSize;
- (NSSize)sizeThatFits:(NSSize)size SWIFT_WARN_UNUSED_RESULT;
- (void)keyDown:(NSEvent * _Nonnull)event;
...
/// \param sender the <code>Menu</code> instance that received the event.
///
/// \param canDragItemAt the index for the item to be dragged.
///
///
/// returns:
...
/// \param sender the <code>Menu</code> instance that received the event.
///
/// \param objectForBeginningDragOperationAt the index for the item to be dragged.
///
///
/// returns:
...
///
/// \param canMoveItemFrom the old index of the item to be moved.
///
/// \param toProposedIndex the new index of the item to be moved.
///
///
/// returns:
...
@property (nonatomic, copy) BOOL (^ _Nullable linkHandler)(id _Nonnull);
...
@property (nonatomic, readonly) NSSize intrinsicContentSize;
- (NSLayoutPriority)contentHuggingPriorityForOrientation:(NSLayoutConstraintOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
- (void)setContentHuggingPriority:(NSLayoutPriority)priority forOrientation:(NSLayoutConstraintOrientation)orientation;
- (NSLayoutPriority)contentCompressionResistancePriorityForOrientation:(NSLayoutConstraintOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
...
@interface PZMMenu : NSObject <NSDraggingSource, NSTableViewDataSource, NSTableViewDelegate, NSWindowDelegate, PZMPanelDelegate, PZMMenuDelegate>
...
enum PZSegmentLayoutMode : NSInteger;
...
+ (PZMSegmentedControlItem * _Nonnull)itemWithLabel:(NSString * _Nullable)label itemIdentifier:(NSString * _Nonnull)itemIdentifier icon:(NSImage * _Nullable)icon count:(NSUInteger)count action:(void (^ _Nullable)(PZMSegmentedControl * _Nonnull))action SWIFT_WARN_UNUSED_RESULT;
+ (PZMSegmentedControlItem * _Nonnull)itemWithLabel:(NSString * _Nullable)label itemIdentifier:(NSString * _Nonnull)itemIdentifier icon:(NSImage * _Nullable)icon count:(NSUInteger)count showBadge:(BOOL)showBadge action:(void (^ _Nullable)(PZMSegmentedControl * _Nonnull))action SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
