...
typedef NS_ENUM(NSInteger, ZAppConsentAction) {
    ...
    ZAppConsentAction_Show_Consent_Dialog,
...
@interface ZMZAppShowConsentTextInfo: NSObject
@property (nonatomic, copy, nullable) NSString *title;
@property (nonatomic, copy, nullable) NSString *message;
@property (nonatomic, copy, nullable) NSString *btnYes;
@property (nonatomic, copy, nullable) NSString *btnNo;
...
@property (nonatomic, strong, nullable) NSArray *participantsList;
@property (nonatomic, strong, nullable) NSArray *videoSettingsList;
@property (nonatomic, strong, nullable) NSArray *audioSettingsList;
...
@property (nonatomic, strong, nullable) ZMZAppShowConsentTextInfo *showConsentTextInfo;
@property (nonatomic, strong, nullable) ZMZAppSetMeetingViewInfo *setMeetingViewInfo;
...
@property (nonatomic, assign) ZMSupportedFileTypeOption supportedFileType;
