...
class AudioQueue extends events_1.default {
    queue;
    isProcessing;
    maxRetries;
    retryDelay;
    ...
    enqueue(audioChunk) {
        ...
        const insertIndex = this.queue.findIndex((item) => item.speaker === queueItem.speaker &&
    ...
    async processQueue() {
        ...
        console.log(`[Audio Queue] Starting queue processing - Current queue:`, this.queue.map((item) => ({
