...
/**
 * @brief Designated for Zoom Meeting notify that the sharing user's has changed the viewer's annotation privilage.
 * @param isSupportAnnotation YES means the share source user enabled the viewer to do annotations. Otherwise the viewer cannot do annotations.
 ...
 */  
- (ZoomSDKError)createCustomizedAnnotation:(ZoomSDKCustomizedAnnotation*_Nullable*_Nonnull)annotation ShareElement:(ZoomSDKShareElement*)element;
/**
