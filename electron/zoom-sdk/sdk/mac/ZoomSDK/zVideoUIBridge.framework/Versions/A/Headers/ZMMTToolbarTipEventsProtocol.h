...
- (void)showAudioCompanionMicErrorTip:(NSString *)title description:(NSString *)description;
- (void)showAudioCompanionMicPoorQualityTip;
- (void)showAudioCompanionSpeakerErrorTip:(NSString *)title description:(NSString *)description;

- (void)showMeetingInfoNewTip;
- (void)hideMeetingInfoNewTip;
