...
#pragma mark - UniversalUI
    ...
    //MARK: vb
    virtual CmmBool CanUseVirtualBackgroundNow() override;
    virtual CmmBool CanUseErasedBackgroundNow() override;
    virtual CmmBool CanUseEnhancedBackgroundNow() override;
    virtual CmmBool CanUseVideo3DAvatarNow() override;
    virtual CmmBool CanUseAudio3DAvatarNow() override;
    virtual CmmBool CanUseVideoFilterNow() override;
    virtual CmmBool CanUseStudioEffectNow() override;
