...
#define Node_AudioRawData_DEF ZoomNodeAudioRawdata
	...
	void onOneWayAudioRawDataReceived(Node_AudioRawData_DEF* data_, uint32_t user_id);
	void onShareAudioRawDataReceived(Node_AudioRawData_DEF* data_, uint32_t user_id);
	void onOneWayInterpreterAudioRawDataReceived(Node_AudioRawData_DEF* data_, ZoomSTRING pLanguageName);
