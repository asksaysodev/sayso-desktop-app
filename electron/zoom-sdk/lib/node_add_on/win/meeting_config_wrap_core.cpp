...
ZNSDKError ZMeetingConfigWrap::EnableZoomDocs(bool bEnable)
{
	ZOOM_SDK_NAMESPACE::SDKError sdkerr = ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingConfiguration().EnableZoomDocs(bEnable);
...
void ZMeetingConfigWrap::RedirectMeetingInputUserInfoDialog(bool bRedirect)
{
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingConfiguration().RedirectMeetingInputUserInfoDialog(bRedirect);
}
void ZMeetingConfigWrap::RedirectConfirmStartArchiveDialog(bool bRedirect)
{
	ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingConfiguration().RedirectConfirmStartArchiveDialog(bRedirect);
}
...
{
	return ZMeetingInputUserInfoHandler::GetInst().GetDefaultDisplayName();
}
bool ZMeetingConfigWrap::CanModifyDefaultDisplayName()
{
	return ZMeetingInputUserInfoHandler::GetInst().CanModifyDefaultDisplayName();
}
bool ZMeetingConfigWrap::IsValidEmail(ZoomSTRING email)
{
	return ZMeetingInputUserInfoHandler::GetInst().IsValidEmail(email);
}
ZNSDKError ZMeetingConfigWrap::InputUserInfo(ZoomSTRING name, ZoomSTRING email)
{
	return ZMeetingInputUserInfoHandler::GetInst().InputUserInfo(name, email);
}
ZNSDKError ZMeetingConfigWrap::CancelInputUserInfo()
{
	return ZMeetingInputUserInfoHandler::GetInst().CancelInputUserInfo();
}

ZoomSTRING ZMeetingConfigWrap::GetArchiveConfirmContent()
{
	return ZMeetingArchiveConfirmHandler::GetInst().GetArchiveConfirmContent();
}
ZNSDKError ZMeetingConfigWrap::JoinWithArchive(bool bStartArchive)
{
	return ZMeetingArchiveConfirmHandler::GetInst().JoinWithArchive(bStartArchive);
}