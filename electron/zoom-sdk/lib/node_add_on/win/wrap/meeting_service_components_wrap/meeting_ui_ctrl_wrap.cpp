...
IMPL_FUNC_0(IMeetingUIController, SwitchToActiveSpeaker, SDKError, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_1(IMeetingUIController, ChangeFloatToActiveSpkVideoSize, SDKError, SDKFloatVideoType, type, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_1(IMeetingUIController, IsMinimizeModeOfFirstScreenMeetingUIWnd, bool, SDKMinimizeUIMode&, mode, false)
//virtual SDKError SwitchMinimizeUIMode4FirstScreenMeetingUIWnd(SDKMinimizeUIMode mode) = 0;
IMPL_FUNC_1(IMeetingUIController, SwitchMinimizeUIMode4FirstScreenMeetingUIWnd, SDKError, SDKMinimizeUIMode, mode, SDKERR_UNINITIALIZE)
