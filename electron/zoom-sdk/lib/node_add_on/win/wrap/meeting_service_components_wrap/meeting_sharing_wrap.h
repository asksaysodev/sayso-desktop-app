...
DEFINE_FUNC_0(GetViewableSharingUserList, IList<unsigned int >*)
////virtual IList<ZoomSDKSharingSourceInfo>* GetSharingSourceInfoList(unsigned int userID) = 0;
DEFINE_FUNC_1(GetSharingSourceInfoList, IList<ZoomSDKSharingSourceInfo>*, unsigned int, userID)
...
CallBack_FUNC_1(onSharingStatus, ZoomSDKSharingSourceInfo, shareInfo)
...
CallBack_FUNC_1(onShareContentNotification, ZoomSDKSharingSourceInfo, shareInfo)
...
CallBack_FUNC_0(onFailedToStartShare)
//virtual void onOptimizingShareForVideoClipStatusChanged(ZoomSDKSharingSourceInfo shareInfo) = 0;
CallBack_FUNC_1(onOptimizingShareForVideoClipStatusChanged, ZoomSDKSharingSourceInfo, shareInfo)
