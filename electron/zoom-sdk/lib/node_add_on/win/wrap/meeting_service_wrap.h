...
DEFINE_FUNC_0(CanSetMeetingTopic, bool)
//virtual SDKError SetMeetingTopic(const zchar_t* sTopic) = 0;
DEFINE_FUNC_1(SetMeetingTopic, SDKError, const zchar_t*, sTopic)
...
DEFINE_FUNC_0(GetMeetingIndicatorController, IMeetingIndicatorController*)
DEFINE_FUNC_0(GetMeetingPollingController, IMeetingPollingController*)
DEFINE_FUNC_0(GetMeetingQAController, IMeetingQAController *)
DEFINE_FUNC_0(GetMeetingWhiteboardController, IMeetingWhiteboardController*)
DEFINE_FUNC_0(GetMeetingDocsController, IMeetingDocsController*)
public:
...
#define T_GetMeetingIndicatorController _GetMeetingIndicatorController
#define T_GetMeetingPollingController _GetMeetingPollingController
#define T_GetMeetingWhiteboardController _GetMeetingWhiteboardController
#define T_GetMeetingDocsController _GetMeetingDocsController
#else
#if defined(WIN32)
...
#define T_GetMeetingIndicatorController GetMeetingIndicatorController
#define T_GetMeetingPollingController GetMeetingPollingController
#define T_GetMeetingWhiteboardController GetMeetingWhiteboardController
#define T_GetMeetingDocsController GetMeetingDocsController
#endif
...
DEFINE_FUNC_AND_MEMBER(T_GetMeetingIndicatorController, IMeetingIndicatorControllerWrap)
DEFINE_FUNC_AND_MEMBER(T_GetMeetingPollingController, IMeetingPollingControllerWrap)
DEFINE_FUNC_AND_MEMBER(T_GetMeetingWhiteboardController, IMeetingWhiteboardControllerWrap)
DEFINE_FUNC_AND_MEMBER(T_GetMeetingDocsController, IMeetingDocsControllerWrap)
#endif
...
CallBack_FUNC_1(onMeetingTopicChanged, const zchar_t*, sTopic)
//virtual void onMeetingFullToWatchLiveStream(const zchar_t* sLiveStreamUrl) = 0;
CallBack_FUNC_1(onMeetingFullToWatchLiveStream, const zchar_t*, sLiveStreamUrl)
