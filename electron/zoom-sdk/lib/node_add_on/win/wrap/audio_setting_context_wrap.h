...
public:
#define T_GetTestAudioDeviceHelper _GetTestAudioDeviceHelper
#else
#define T_GetTestAudioDeviceHelper GetTestAudioDeviceHelper
#endif
DEFINE_FUNC_AND_MEMBER(T_GetTestAudioDeviceHelper, ITestAudioDeviceHelperWrap)
