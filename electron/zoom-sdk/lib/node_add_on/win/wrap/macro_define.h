...
#define CallBack_FUNC_4(funcname, T1, P1, T2, P2, T3, P3, T4, P4)\
virtual void funcname(T1 P1, T2 P2, T3 P3, T4 P4)\
{\
	if (NULL != m_cb##funcname)\
		m_cb##funcname(P1, P2, P3, P4);\
	if (NULL != external_cb)\
		external_cb->funcname(P1, P2, P3, P4);\
}\
std::function<void(T1, T2, T3, T4)> m_cb##funcname;
