...
IMPL_FUNC_1(IMeetingService, GetSharingConnQuality, ConnectionQuality, bool, bSending, Conn_Quality_Unknown)
//virtual ConnectionQuality GetVideoConnQuality(bool bSending = true) = 0;
IMPL_FUNC_1(IMeetingService, GetVideoConnQuality, ConnectionQuality, bool, bSending, Conn_Quality_Unknown)
//virtual ConnectionQuality GetAudioConnQuality(bool bSending = true) = 0;
IMPL_FUNC_1(IMeetingService, GetAudioConnQuality, ConnectionQuality, bool, bSending, Conn_Quality_Unknown)
...
IMPL_FUNC_0(IMeetingService, GetSharingConnQuality, ConnectionQuality, Conn_Quality_Unknown);
IMPL_FUNC_0(IMeetingService, GetVideoConnQuality, ConnectionQuality, Conn_Quality_Unknown);
IMPL_FUNC_0(IMeetingService, GetAudioConnQuality, ConnectionQuality, Conn_Quality_Unknown);
IMPL_FUNC_0(IMeetingService, CanSetMeetingTopic, bool, false);
IMPL_FUNC_1(IMeetingService, SetMeetingTopic, SDKError, const zchar_t*, sTopic, SDKERR_UNINITIALIZE)
#if defined(WIN32)
...
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingIndicatorController, IMeetingIndicatorControllerWrap);
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingPollingController, IMeetingPollingControllerWrap);
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingQAController, IMeetingQAControllerWrap)
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingWhiteboardController, IMeetingWhiteboardControllerWrap);
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingDocsController, IMeetingDocsControllerWrap);
#endif
...
IMPL_FUNC_0(IMeetingService, GetMeetingIndicatorController, IMeetingIndicatorController*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingQAController, IMeetingQAControllerWrap*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingPollingController, IMeetingPollingControllerWrap*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingWhiteboardController, IMeetingWhiteboardController*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingDocsController, IMeetingDocsController*, NULL)
#endif
