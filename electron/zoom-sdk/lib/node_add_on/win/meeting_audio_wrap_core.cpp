...
ZNSDKError ZMeetingAudioWrap::EnableMuteOnEntry(bool bEnable, bool allowUnmuteBySelf)
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingAudioController().EnableMuteOnEntry(bEnable, allowUnmuteBySelf));
}
bool ZMeetingAudioWrap::CanEnableMuteOnEntry()
{
	return ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingAudioController().CanEnableMuteOnEntry();
}
bool ZMeetingAudioWrap::IsMuteOnEntryEnabled()
{
	return ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingAudioController().IsMuteOnEntryEnabled();
}
ZNSDKError ZMeetingAudioWrap::EnablePlayMeetingAudio(bool bEnable)
{
	return Map2WrapDefine(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingAudioController().EnablePlayMeetingAudio(bEnable));
}
bool ZMeetingAudioWrap::IsPlayMeetingAudioEnabled()
{
	return ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().T_GetMeetingAudioController().IsPlayMeetingAudioEnabled();
}
...
void ZMeetingAudioWrap::onMuteOnEntryStatusChange(bool bEnabled)
{
	if (m_pSink)
		m_pSink->onMuteOnEntryStatusChange(bEnabled);
}