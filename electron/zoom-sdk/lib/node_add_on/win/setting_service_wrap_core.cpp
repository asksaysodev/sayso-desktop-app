...
void ZSettingServiceWrap::Init()
{
	...
	m_setting_wallpaper_ctrl.Init();
	m_setting_virtual_bg_ctrl.Init();
}
...
ZSettingWallpaperWrap& ZSettingServiceWrap::GetSettingWallpaperCtrl()
{
	return m_setting_wallpaper_ctrl;
}
ZSettingVirtualBGWrap& ZSettingServiceWrap::GetSettingVirtualBGCtrl()
{
	return m_setting_virtual_bg_ctrl;
}
