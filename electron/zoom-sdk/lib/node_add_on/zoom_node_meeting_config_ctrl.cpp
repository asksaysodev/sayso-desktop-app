...
void ZoomNodeMeetingConfigCtrlWrap::EnableZoomDocs(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::EnableZoomDocsParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::EnableZoomDocsParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		...
		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().EnableZoomDocs(_bEnable);
	} while (false);
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingNeedToUpgradeCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		ZoomNodeSinkHelper::GetInst().onFreeMeetingNeedToUpgrade.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToGiftFreeTrialStartCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToGiftFreeTrialStart.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToGiftFreeTrialStopCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToGiftFreeTrialStop.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToProMeetingCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToProMeeting.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::RedirectMeetingInputUserInfoDialog(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::RedirectMeetingInputUserInfoDialogParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::RedirectMeetingInputUserInfoDialogParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		...
		_g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().RedirectMeetingInputUserInfoDialog(_bRedirect);
	} while (false);
	
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::RedirectConfirmStartArchiveDialog(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::RedirectConfirmStartArchiveDialogParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::RedirectConfirmStartArchiveDialogParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		...
		_g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().RedirectConfirmStartArchiveDialog(_bRedirect);
	} while (false);
...
void ZoomNodeMeetingConfigCtrlWrap::GetDefaultDisplayName(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZoomSTRING defaultDisplayName = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().GetDefaultDisplayName();
	v8::Local<v8::String> bret = v8::String::NewFromUtf8(isolate, zs2s(defaultDisplayName).c_str(), v8::NewStringType::kInternalized).ToLocalChecked();
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::CanModifyDefaultDisplayName(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	bool zn_bCan = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().CanModifyDefaultDisplayName();	
	v8::Local<v8::Boolean> bret = v8::Boolean::New(isolate, zn_bCan);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::IsValidEmail(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	bool err = false;
	do
	{
		com::electron::sdk::proto::IsValidEmailParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::IsValidEmailParams >(args, proto_params))
		{
			break;
		}
		if (!proto_params.has_email())
		...
		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().IsValidEmail(_zn_email);
	} while (false);
	
	v8::Local<v8::Boolean> bret = v8::Boolean::New(isolate, err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::InputUserInfo(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::InputUserInfoParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::InputUserInfoParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_name() ||
			!proto_params.has_email()
			)
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		...
		ZoomSTRING _zn_name;
		_zn_name = s2zs(proto_params.name());
		ZoomSTRING _zn_email;
		_zn_email = s2zs(proto_params.email());

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().InputUserInfo(_zn_name, _zn_email);
	} while (false);
	
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::CancelInputUserInfo(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().CancelInputUserInfo();
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::GetArchiveConfirmContent(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZoomSTRING defaultDisplayName = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().GetArchiveConfirmContent();
	v8::Local<v8::String> bret = v8::String::NewFromUtf8(isolate, zs2s(defaultDisplayName).c_str(), v8::NewStringType::kInternalized).ToLocalChecked();
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::JoinWithArchive(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::JoinWithArchiveParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::JoinWithArchiveParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_bstartarchive())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		bool _bStartArchive = false;
		convertBool(proto_params.bstartarchive(), _bStartArchive);

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().JoinWithArchive(_bStartArchive);
	} while (false);
...
void ZoomNodeMeetingConfigCtrlWrap::SetInputMeetingPasswordAndScreenNameNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onInputMeetingPasswordAndScreenNameNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetAirPlayInstructionWndNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onAirPlayInstructionWndNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonWebinarNeedRegisterNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onWebinarNeedRegisterNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonEndOtherMeetingToJoinMeetingNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onEndOtherMeetingToJoinMeetingNotification.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonFreeMeetingRemainTimeCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onFreeMeetingRemainTime.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonFreeMeetingRemainTimeStopCountDownCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onFreeMeetingRemainTimeStopCountDown.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonWebinarNeedInputScreenNameCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onWebinarNeedInputScreenName.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonJoinMeetingNeedUserInfoCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onJoinMeetingNeedUserInfo.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onJoinMeetingNeedUserInfo.Reset(isolate, cbfunc);
...
void ZoomNodeMeetingConfigCtrlWrap::SetonUserConfirmToStartArchiveCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onUserConfirmToStartArchive.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		ZoomNodeSinkHelper::GetInst().onUserConfirmToStartArchive.Reset(isolate, cbfunc);
