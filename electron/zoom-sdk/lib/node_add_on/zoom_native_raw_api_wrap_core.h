...
public:
	...
	ZNSDKError Subscribe(uint32_t subscribeId, ZNZoomSDKRawDataType type, unsigned long long recv_handle);
	...
	ZNSDKError GetSubscribeId(uint32_t& subscribeId, unsigned long long recv_handle);
