...
{
    m_pSink = 0;
    ZoomSDKH323Helper *helper = [[[ZoomSDK sharedSDK] getMeetingService] getH323Helper];
    if(helper)
    {
        helper.delegate = nil;
    }
...
void  ZMeetingH323Wrap::SetSink(ZNativeSDKMeetingH323WrapSink *pSink)
{
    ...
    if(helper)
    {
        helper.delegate = [[meetingH323HelperDelegate alloc] init];
    }
}
...
ZNList<ZNH323DeviecInfo> ZMeetingH323Wrap::GetCalloutH323DeviceList()
{
