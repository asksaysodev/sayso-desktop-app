...
public:
	...
	static void SetPipeClientInitParam(const v8::FunctionCallbackInfo<v8::Value>& args);
...
static void InitClassAttribute<ZoomNodeRenderWrap >(const v8::Local<v8::FunctionTemplate>& tpl, v8::Isolate* isolate)
{
	...
	NODE_SET_PROTOTYPE_METHOD(tpl, "SetPipeClientInitParam", ZoomNodeRenderWrap::SetPipeClientInitParam);
}
template<>
