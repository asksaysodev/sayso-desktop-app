...
void ZoomNodeMeetingAnnotationWrap::SetOnSupportAnnotationStatusCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onSupportAnnotationStatus.Clear();
			break;
		}
		...
		ZoomNodeSinkHelper::GetInst().onSupportAnnotationStatus.Reset(isolate, cbfunc);
