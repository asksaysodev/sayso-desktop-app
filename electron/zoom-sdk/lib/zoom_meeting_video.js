  ...
  function init(opts) {
    ...
    */
    ...
    return {
      ...
      * @param {Number} mode Defined in: {@link SDKVideoPreferenceMode}
      ...
      * @param {Number} minimumFrameRate 0 for the default value,maximum_frame_rate should be less and equal than 30, range: from 0 to 30.out of range for frame-rate will use default frame-rate of Zoom
      * @return {Number} If the function succeed, the return value is SDKERR_SUCCESS.
	      Otherwise failed. To get extended error information, Defined in: {@link ZoomSDKError}
      */
